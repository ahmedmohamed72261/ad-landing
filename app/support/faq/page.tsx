...
const faqData = [
  {
    category: "الحسابات والإعداد",
    questions: [
      {
        q: "كيف يمكنني إنشاء حساب جديد؟",
        a: "يمكنك إنشاء حساب جديد بالنقر على زر 'ابدأ الآن' في الصفحة الرئيسية، ثم ملء البيانات المطلوبة وتأكيد البريد الإلكتروني.",
      },
      {
        q: "هل يمكنني ربط عدة حسابات إعلانية؟",
        a: "نعم، يمكنك ربط حسابات متعددة من جوجل، فيسبوك، إنستغرام، وغيرها من المنصات الإعلانية من خلال لوحة التحكم.",
      },
      {
        q: "كيف أقوم بتغيير كلمة المرور؟",
        a: "اذهب إلى الإعدادات > الأمان > تغيير كلمة المرور، أو استخدم رابط 'نسيت كلمة المرور' في صفحة تسجيل الدخول.",
      },
    ],
  },
  {
